...
class Comment
{
    ...
    public function comment()
    {
        try {
            ...
            $stmt->bindValue(':user_id', htmlspecialchars(strip_tags($this->user_id)));
            $stmt->bindValue(':post_id', htmlspecialchars(strip_tags($this->post_id)));
            $stmt->bindValue(':comment', htmlspecialchars(strip_tags($this->comment)));
