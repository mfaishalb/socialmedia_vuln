<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" action="people.php">
            ...
            <input value="<?php echo isset($_GET['name']) ? htmlspecialchars($_GET['name']) : ''; ?>" 
  name="name" class="form-control mr-sm-2" type="search" placeholder="Search people" aria-label="Search">
